...
public class USEI07_UI implements Runnable {
    ...
    public void run() {
        try {
            ...
            System.out.print("Indique o numero do local de origem");
            ...
            MostHubsPath<Node> result = USEI07.maxHubs(graph, VOrig, time, velo, auto, carga, descarga);
